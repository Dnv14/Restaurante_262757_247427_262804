...
public class MenuClientesFrecuentesFORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MenuClientesFrecuentesFORM
     */
    public MenuClientesFrecuentesFORM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblNombreCompleto.setText("Seleccione una de las opciones de Cliente:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuClientesFrecuentesFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuClientesFrecuentesFORM().setVisible(true);
            }
        });
    }
