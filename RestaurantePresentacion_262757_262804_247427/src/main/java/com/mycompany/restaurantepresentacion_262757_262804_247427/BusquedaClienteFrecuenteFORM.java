...
public class BusquedaClienteFrecuenteFORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form BusquedaClienteFrecuenteFORM
     */
    public BusquedaClienteFrecuenteFORM() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaClienteFrecuenteFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaClienteFrecuenteFORM().setVisible(true);
            }
        });
    }
